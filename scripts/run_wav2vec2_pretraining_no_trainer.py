...
from scripts.helpers.custom_wav2vec2 import Wav2Vec2ForPreTraining, Wav2Vec2FeatureExtractor
from scripts.helpers.custom_wav2vec2_configuration import Wav2Vec2Config
...
def parse_args():
    ...
    parser.add_argument(
        "--use_bottleneck_adapter",
        action="store_true",
        default=False,
        help="Flag for bottleneck adapters",
    )
    parser.add_argument(
        "--unfreeze_encoder",
        action="store_true",
    ...
    parser.add_argument(
        "--bottleneck_adapter_dim",
        type=int,
        default=256,
        help="Dimension for bottleneck adapters",
    )
    parser.add_argument(
        "--bottleneck_adapter_act",
        type=str,
        default="gelu",
